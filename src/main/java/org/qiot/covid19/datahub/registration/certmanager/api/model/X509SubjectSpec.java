...
@JsonPropertyOrder({ "organizations", "countries", "organizationalUnits", "localities", "provinces", "streetAddresses",
		"postalCodes", "serialNumber" })
@EqualsAndHashCode
@Builder
@RegisterForReflection
@NoArgsConstructor
@AllArgsConstructor
public class X509SubjectSpec implements UnknownPropertyPreserving, Serializable {
