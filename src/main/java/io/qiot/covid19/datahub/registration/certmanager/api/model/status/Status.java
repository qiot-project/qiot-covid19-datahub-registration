...
import io.qiot.covid19.datahub.registration.certmanager.api.model.UnknownPropertyPreserving;
...
public abstract class Status
    ...
    private List<Condition> prepareConditionsUpdate() {
        ...
        List<Condition> newConditions = oldConditions != null
                ? new ArrayList<>(oldConditions)
                : new ArrayList<>(0);
